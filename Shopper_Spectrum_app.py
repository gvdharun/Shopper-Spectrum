...
scaler = joblib.load('models/rfm_scaled.pkl')
kmeans = joblib.load('modelsrfm_kmeans.pkl')
rfm_df = pd.read_csv('data/rfm_segmented.csv')
product_sim_df = pd.read_pickle('data/product_similarity.pkl')
product_mapping = pd.read_pickle('dataproduct_mapping.pkl')
